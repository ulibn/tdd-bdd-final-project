...
class TestProductModel(unittest.TestCase):
    ...
    def test_read_a_product(self):
        ...
        product.create()
        self.assertIsNotNone(product.id)
        p_found = Product.find(product.id)
        self.assertEqual(p_found.id, product.id)
        self.assertEqual(p_found.name, product.name)
        self.assertEqual(p_found.description, product.description)
        self.assertEqual(p_found.price, product.price)
    ...
    def test_update_invalid_product(self):
        """It should raise exeption Update invalid Product"""
        product = ProductFactory()
        product.create()
        product.id = None
    ...
    def test_invalid_deserialize(self):
        """It should Raise exception when deserialize invalid data"""
        product = ProductFactory()
